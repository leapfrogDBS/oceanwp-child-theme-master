...
<section id="student-hero" class ="bg-gradient-to-tr from-cyan via-blue to-purple pb-0 relative">
    <div class="container3 lg:mt-20">
        <div class="row">
            ...
            <div class="column lg:col-span-7 lg:col-start-6 lg:row-start-1 flex flex-col justify-end">
                <img src="<?php echo get_stylesheet_directory_uri();?>/img/parent/hero-photo.png" class="w-full h-auto hidden lg:block">
                <img src="<?php echo get_stylesheet_directory_uri();?>/img/parent/hero-mobile.png" class="w-full h-full scale-[1.35] max-w-[280px] m-auto origin-bottom z-30 lg:hidden">
            </div>
        </div>
    </div>
</section>
