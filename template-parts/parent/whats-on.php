            ...
            <div class="column lg:col-span-7 flex flex-col justify-center mb-16 px-12 md:px-[8%] lg:pr-0 lg:pl-[16.6%]">
                ...
                <?php if($student_whats_on_button_text && $student_whats_on_button_link) { ?>
                    <div class="inline-block">
                        <a href="<?php echo $student_whats_on_button_link['url']; ?>" class="ctaButton bg-white text-purple"><?php echo $student_whats_on_button_text; ?><img src="<?php echo get_stylesheet_directory_uri();?>/img/purple-arrow-button.svg"></a>
                    </div>
                <?php } ?>
            </div>
            <div class="column lg:col-span-6 lg:col-start-7 relative -mt-24 lg:mt-0">
                <img src="<?php echo get_stylesheet_directory_uri();?>/img/parent/events-desktop.png" class="w-full h-full hidden lg:block lg:absolute lg:bottom-0 lg:h-auto ">
